...
namespace ICD.Connect.Protocol.Network.WebPorts.CoreHttp
{
	...
	{
		private const string FACTORY_NAME = "HttpPort";
		...
		/// </summary>
		public override Type OriginatorType { get { return typeof(CoreHttpPort); } }
		...
		public static CoreHttpPortSettings FromXml(string xml)
		{
			CoreHttpPortSettings output = new CoreHttpPortSettings
			{
		...
		/// <param name="xml"></param>
		/// <returns></returns>
		[PublicAPI, XmlFactoryMethod("HttpsPort")]
		public static CoreHttpPortSettings FromXmlBackwardsCompat(string xml)
		{
			return FromXml(xml);
		}
