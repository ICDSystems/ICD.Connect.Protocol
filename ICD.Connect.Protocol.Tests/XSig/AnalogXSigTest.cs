...
namespace ICD.Connect.Protocol.Tests.XSig
{
    ...
    public sealed class AnalogXSigTest
    {
        ...
        [TestCase((ushort)233, (ushort)11, "\xC0\x0A\x01\x69")]
        ...
        [TestCase((ushort)233, "\xC0\x0A\x01\x69")]
        ...
        [TestCase((ushort)11, "\xC0\x0A\x01\x69")]
